...
/* 34 */     registerClientbound((ClientboundPacketType)ClientboundPackets1_9.JOIN_GAME, (PacketHandler)new PacketHandlers()
/*    */         {
/*    */           public void register() {
/* 37 */             map((Type)Type.INT);
/* 38 */             map((Type)Type.UNSIGNED_BYTE);
/*    */             
/* 40 */             map((Type)Type.INT, (Type)Type.BYTE);
/* 41 */             map((Type)Type.UNSIGNED_BYTE);
/* 42 */             map((Type)Type.UNSIGNED_BYTE);
/* 43 */             map(Type.STRING);
/* 44 */             map((Type)Type.BOOLEAN);
/*    */           }
/*    */         });
/*    */     
/* 48 */     registerClientbound((ClientboundPacketType)ClientboundPackets1_9.SOUND, (PacketHandler)new PacketHandlers()
/*    */         {
/*    */           public void register() {
...
/* Location:              C:\Users\march\Desktop\Diavlo-client.jar!\com\viaversion\viabackwards\protocol\protocol1_9to1_9_1\Protocol1_9To1_9_1.class
