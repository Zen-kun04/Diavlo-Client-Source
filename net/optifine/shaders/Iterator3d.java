...
/*  31 */     Vec3 vec3 = new Vec3((posEnd.getX() - posStart.getX()), (posEnd.getY() - posStart.getY()), (posEnd.getZ() - posStart.getZ()));
/*  32 */     Vec3 vec31 = vec3.normalize();
/*  33 */     Vec3 vec32 = new Vec3(1.0D, 0.0D, 0.0D);
/*  34 */     double d0 = vec31.dotProduct(vec32);
/*  35 */     double d1 = Math.abs(d0);
/*  36 */     Vec3 vec33 = new Vec3(0.0D, 1.0D, 0.0D);
/*  37 */     double d2 = vec31.dotProduct(vec33);
/*  38 */     double d3 = Math.abs(d2);
/*  39 */     Vec3 vec34 = new Vec3(0.0D, 0.0D, 1.0D);
/*  40 */     double d4 = vec31.dotProduct(vec34);
...
/* 138 */       System.out.println("" + blockpos2);
/*     */     } 
/*     */   }
/*     */ }
