...
/*     */       
/*  79 */       if (index < this.horseInventory.getSizeInventory()) {
/*     */         
/*  81 */         if (!mergeItemStack(itemstack1, this.horseInventory.getSizeInventory(), this.inventorySlots.size(), true))
/*     */         {
/*  83 */           return null;
/*     */         }
/*     */       }
/*  86 */       else if (getSlot(1).isItemValid(itemstack1) && !getSlot(1).getHasStack()) {
/*     */         
/*  88 */         if (!mergeItemStack(itemstack1, 1, 2, false))
/*     */         {
/*  90 */           return null;
/*     */         }
/*     */       }
/*  93 */       else if (getSlot(0).isItemValid(itemstack1)) {
/*     */         
/*  95 */         if (!mergeItemStack(itemstack1, 0, 1, false))
/*     */         {
/*  97 */           return null;
/*     */         }
/*     */       }
/* 100 */       else if (this.horseInventory.getSizeInventory() <= 2 || !mergeItemStack(itemstack1, 2, this.horseInventory.getSizeInventory(), false)) {
/*     */         
/* 102 */         return null;
/*     */       } 
/*     */       
...
/* 120 */     super.onContainerClosed(playerIn);
/* 121 */     this.horseInventory.closeInventory(playerIn);
/*     */   }
/*     */ }
