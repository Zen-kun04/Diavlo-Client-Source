...
/* 36 */     this.action = (Action)buf.readEnumValue(Action.class);
/*    */     
/* 38 */     if (this.action == Action.INTERACT_AT)
/*    */     {
/* 40 */       this.hitVec = new Vec3(buf.readFloat(), buf.readFloat(), buf.readFloat());
/*    */     }
/*    */   }
/*    */ 
/*    */   
...
/*    */       
/* 51 */       buf.writeFloat((float)this.hitVec.xCoord);
/* 52 */       buf.writeFloat((float)this.hitVec.yCoord);
/* 53 */       buf.writeFloat((float)this.hitVec.zCoord);
/*    */     } 
/*    */   }
/*    */ 
/*    */   
/*    */   public void processPacket(INetHandlerPlayServer handler) {
/* 59 */     handler.processUseEntity(this);
/*    */   }
/*    */ 
/*    */   
