...
/*    */   
/*    */   public World init() {
/* 58 */     this.mapStorage = this.delegate.getMapStorage();
/* 59 */     this.worldScoreboard = this.delegate.getScoreboard();
/* 60 */     String s = VillageCollection.fileNameForProvider(this.provider);
/* 61 */     VillageCollection villagecollection = (VillageCollection)this.mapStorage.loadData(VillageCollection.class, s);
/*    */     
/* 63 */     if (villagecollection == null) {
/*    */       
/* 65 */       this.villageCollectionObj = new VillageCollection(this);
/* 66 */       this.mapStorage.setData(s, (WorldSavedData)this.villageCollectionObj);
/*    */     }
/*    */     else {
/*    */       
/* 70 */       this.villageCollectionObj = villagecollection;
/* 71 */       this.villageCollectionObj.setWorldsForAll(this);
/*    */     } 
/*    */     
/* 74 */     return this;
/*    */   }
