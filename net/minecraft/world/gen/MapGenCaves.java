...
/*     */                             
/* 201 */                             blockpos$mutableblockpos.set(j3 + p_180702_3_ * 16, 0, i2 + p_180702_4_ * 16);
...
/* 229 */     int i = this.rand.nextInt(this.rand.nextInt(this.rand.nextInt(15) + 1) + 1);
/*     */     
...
/*     */       
/* 238 */       double d0 = (chunkX * 16 + this.rand.nextInt(16));
/* 239 */       double d1 = this.rand.nextInt(this.rand.nextInt(120) + 8);
/* 240 */       double d2 = (chunkZ * 16 + this.rand.nextInt(16));
/* 241 */       int k = 1;
/*     */       
/* 243 */       if (this.rand.nextInt(4) == 0) {
/*     */         
/* 245 */         func_180703_a(this.rand.nextLong(), p_180701_4_, p_180701_5_, chunkPrimerIn, d0, d1, d2);
/* 246 */         k += this.rand.nextInt(4);
/*     */       } 
/*     */       
/* 249 */       for (int l = 0; l < k; l++) {
/*     */         
/* 251 */         float f = this.rand.nextFloat() * 3.1415927F * 2.0F;
/* 252 */         float f1 = (this.rand.nextFloat() - 0.5F) * 2.0F / 8.0F;
/* 253 */         float f2 = this.rand.nextFloat() * 2.0F + this.rand.nextFloat();
/*     */         
/* 255 */         if (this.rand.nextInt(10) == 0)
/*     */         {
/* 257 */           f2 *= this.rand.nextFloat() * this.rand.nextFloat() * 3.0F + 1.0F;
/*     */         }
/*     */         
/* 260 */         func_180702_a(this.rand.nextLong(), p_180701_4_, p_180701_5_, chunkPrimerIn, d0, d1, d2, f2, f, f1, 0, 0, 1.0D);
/*     */       } 
/*     */     } 
/*     */   }
/*     */ }
