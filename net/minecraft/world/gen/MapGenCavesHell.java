...
/* 190 */     int i = this.rand.nextInt(this.rand.nextInt(this.rand.nextInt(10) + 1) + 1);
/*     */     
/* 192 */     if (this.rand.nextInt(5) != 0)
/*     */     {
/* 194 */       i = 0;
/*     */     }
/*     */     
...
/*     */       
/* 199 */       double d0 = (chunkX * 16 + this.rand.nextInt(16));
/* 200 */       double d1 = this.rand.nextInt(128);
/* 201 */       double d2 = (chunkZ * 16 + this.rand.nextInt(16));
/* 202 */       int k = 1;
/*     */       
/* 204 */       if (this.rand.nextInt(4) == 0) {
/*     */         
/* 206 */         func_180705_a(this.rand.nextLong(), p_180701_4_, p_180701_5_, chunkPrimerIn, d0, d1, d2);
/* 207 */         k += this.rand.nextInt(4);
/*     */       } 
/*     */       
/* 210 */       for (int l = 0; l < k; l++) {
/*     */         
/* 212 */         float f = this.rand.nextFloat() * 3.1415927F * 2.0F;
/* 213 */         float f1 = (this.rand.nextFloat() - 0.5F) * 2.0F / 8.0F;
/* 214 */         float f2 = this.rand.nextFloat() * 2.0F + this.rand.nextFloat();
/* 215 */         func_180704_a(this.rand.nextLong(), p_180701_4_, p_180701_5_, chunkPrimerIn, d0, d1, d2, f2 * 2.0F, f, f1, 0, 0, 0.5D);
/*     */       } 
/*     */     } 
/*     */   }
/*     */ }
