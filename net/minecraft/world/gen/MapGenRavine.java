...
/*     */                             
/* 185 */                             blockpos$mutableblockpos.set(j3 + p_180707_3_ * 16, 0, i2 + p_180707_4_ * 16);
...
/* 208 */     if (this.rand.nextInt(50) == 0) {
/*     */       
/* 210 */       double d0 = (chunkX * 16 + this.rand.nextInt(16));
/* 211 */       double d1 = (this.rand.nextInt(this.rand.nextInt(40) + 8) + 20);
/* 212 */       double d2 = (chunkZ * 16 + this.rand.nextInt(16));
/* 213 */       int i = 1;
/*     */       
/* 215 */       for (int j = 0; j < i; j++) {
/*     */         
/* 217 */         float f = this.rand.nextFloat() * 3.1415927F * 2.0F;
/* 218 */         float f1 = (this.rand.nextFloat() - 0.5F) * 2.0F / 8.0F;
/* 219 */         float f2 = (this.rand.nextFloat() * 2.0F + this.rand.nextFloat()) * 2.0F;
/* 220 */         func_180707_a(this.rand.nextLong(), p_180701_4_, p_180701_5_, chunkPrimerIn, d0, d1, d2, f2, f, f1, 0, 0, 3.0D);
/*     */       } 
/*     */     } 
/*     */   }
/*     */ }
