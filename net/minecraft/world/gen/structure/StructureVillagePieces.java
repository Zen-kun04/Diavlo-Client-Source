...
/*   51 */     list.add(new PieceWeight((Class)House4Garden.class, 4, MathHelper.getRandomIntegerInRange(random, 2 + size, 4 + size * 2)));
/*   52 */     list.add(new PieceWeight((Class)Church.class, 20, MathHelper.getRandomIntegerInRange(random, 0 + size, 1 + size)));
/*   53 */     list.add(new PieceWeight((Class)House1.class, 20, MathHelper.getRandomIntegerInRange(random, 0 + size, 2 + size)));
/*   54 */     list.add(new PieceWeight((Class)WoodHut.class, 3, MathHelper.getRandomIntegerInRange(random, 2 + size, 5 + size * 3)));
/*   55 */     list.add(new PieceWeight((Class)Hall.class, 15, MathHelper.getRandomIntegerInRange(random, 0 + size, 2 + size)));
/*   56 */     list.add(new PieceWeight((Class)Field1.class, 3, MathHelper.getRandomIntegerInRange(random, 1 + size, 4 + size)));
/*   57 */     list.add(new PieceWeight((Class)Field2.class, 3, MathHelper.getRandomIntegerInRange(random, 2 + size, 4 + size * 2)));
/*   58 */     list.add(new PieceWeight((Class)House2.class, 15, MathHelper.getRandomIntegerInRange(random, 0, 1 + size)));
/*   59 */     list.add(new PieceWeight((Class)House3.class, 8, MathHelper.getRandomIntegerInRange(random, 0 + size, 3 + size * 2)));
...
/*      */           
/* 1575 */           blockpos$mutableblockpos.set(l, 64, k);
/*      */           
...
/* 1618 */           entityvillager.onInitialSpawn(worldIn.getDifficultyForLocation(new BlockPos((Entity)entityvillager)), (IEntityLivingData)null);
