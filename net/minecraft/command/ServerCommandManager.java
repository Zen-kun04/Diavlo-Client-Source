...
/*     */     
/* 116 */     if (!sender.sendCommandFeedback())
/*     */     {
/* 118 */       flag = false;
/*     */     }
/*     */     
/* 121 */     ChatComponentTranslation chatComponentTranslation = new ChatComponentTranslation("chat.type.admin", new Object[] { sender.getName(), new ChatComponentTranslation(msgFormat, msgParams) });
/* 122 */     chatComponentTranslation.getChatStyle().setColor(EnumChatFormatting.GRAY);
/* 123 */     chatComponentTranslation.getChatStyle().setItalic(Boolean.valueOf(true));
/*     */     
/* 125 */     if (flag)
/*     */     {
/* 127 */       for (EntityPlayer entityplayer : minecraftserver.getConfigurationManager().getPlayerList()) {
/*     */         
/* 129 */         if (entityplayer != sender && minecraftserver.getConfigurationManager().canSendCommands(entityplayer.getGameProfile()) && command.canCommandSenderUseCommand(sender)) {
/*     */           
/* 131 */           boolean flag1 = (sender instanceof MinecraftServer && MinecraftServer.getServer().shouldBroadcastConsoleToOps());
/* 132 */           boolean flag2 = (sender instanceof net.minecraft.network.rcon.RConConsoleSource && MinecraftServer.getServer().shouldBroadcastRconToOps());
/*     */           
/* 134 */           if (flag1 || flag2 || (!(sender instanceof net.minecraft.network.rcon.RConConsoleSource) && !(sender instanceof MinecraftServer)))
/*     */           {
/* 136 */             entityplayer.addChatMessage((IChatComponent)chatComponentTranslation);
/*     */           }
/*     */         } 
/*     */       } 
/*     */     }
/*     */     
/* 142 */     if (sender != minecraftserver && minecraftserver.worldServers[0].getGameRules().getBoolean("logAdminCommands"))
/*     */     {
/* 144 */       minecraftserver.addChatMessage((IChatComponent)chatComponentTranslation);
/*     */     }
/*     */     
/* 147 */     boolean flag3 = minecraftserver.worldServers[0].getGameRules().getBoolean("sendCommandFeedback");
/*     */     
/* 149 */     if (sender instanceof CommandBlockLogic)
/*     */     {
/* 151 */       flag3 = ((CommandBlockLogic)sender).shouldTrackOutput();
/*     */     }
/*     */     
/* 154 */     if (((flags & 0x1) != 1 && flag3) || sender instanceof MinecraftServer)
/*     */     {
