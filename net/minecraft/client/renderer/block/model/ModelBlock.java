...
/*  45 */     return deserialize(new StringReader(jsonString));
/*     */   }
/*     */ 
/*     */   
...
/*  50 */     this((ResourceLocation)null, elementsIn, texturesIn, ambientOcclusionIn, gui3dIn, cameraTransformsIn);
/*     */   }
/*     */ 
/*     */   
...
/*  55 */     this(parentLocationIn, Collections.emptyList(), texturesIn, ambientOcclusionIn, gui3dIn, cameraTransformsIn);
/*     */   }
/*     */ 
/*     */   
...
/* 168 */     ItemTransformVec3f itemtransformvec3f = getTransform(ItemCameraTransforms.TransformType.THIRD_PERSON);
/* 169 */     ItemTransformVec3f itemtransformvec3f1 = getTransform(ItemCameraTransforms.TransformType.FIRST_PERSON);
/* 170 */     ItemTransformVec3f itemtransformvec3f2 = getTransform(ItemCameraTransforms.TransformType.HEAD);
/* 171 */     ItemTransformVec3f itemtransformvec3f3 = getTransform(ItemCameraTransforms.TransformType.GUI);
/* 172 */     ItemTransformVec3f itemtransformvec3f4 = getTransform(ItemCameraTransforms.TransformType.GROUND);
/* 173 */     ItemTransformVec3f itemtransformvec3f5 = getTransform(ItemCameraTransforms.TransformType.FIXED);
...
/* 179 */     return (this.parent != null && !this.cameraTransforms.func_181687_c(type)) ? this.parent.getTransform(type) : this.cameraTransforms.getTransform(type);
/*     */   }
/*     */ 
/*     */   
