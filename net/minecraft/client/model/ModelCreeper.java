...
/* 50 */     this.head.render(scale);
/* 51 */     this.body.render(scale);
/* 52 */     this.leg1.render(scale);
/* 53 */     this.leg2.render(scale);
/* 54 */     this.leg3.render(scale);
/* 55 */     this.leg4.render(scale);
/*    */   }
/*    */ 
/*    */   
/*    */   public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
/* 60 */     this.head.rotateAngleY = netHeadYaw / 57.295776F;
/* 61 */     this.head.rotateAngleX = headPitch / 57.295776F;
/* 62 */     this.leg1.rotateAngleX = MathHelper.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAmount;
/* 63 */     this.leg2.rotateAngleX = MathHelper.cos(limbSwing * 0.6662F + 3.1415927F) * 1.4F * limbSwingAmount;
/* 64 */     this.leg3.rotateAngleX = MathHelper.cos(limbSwing * 0.6662F + 3.1415927F) * 1.4F * limbSwingAmount;
/* 65 */     this.leg4.rotateAngleX = MathHelper.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAmount;
/*    */   }
/*    */ }
