...
/* 200 */     this.sndManager.playDelayedSound(sound, delay);
/*     */   }
/*     */ 
/*     */   
/*     */   public void setListener(EntityPlayer player, float p_147691_2_) {
/* 205 */     this.sndManager.setListener(player, p_147691_2_);
/*     */   }
/*     */ 
/*     */   
/*     */   public void pauseSounds() {
/* 210 */     this.sndManager.pauseAllSounds();
/*     */   }
/*     */ 
/*     */   
/*     */   public void stopSounds() {
/* 215 */     this.sndManager.stopAllSounds();
/*     */   }
/*     */ 
/*     */   
/*     */   public void unloadSounds() {
/* 220 */     this.sndManager.unloadSoundSystem();
/*     */   }
/*     */ 
/*     */   
/*     */   public void update() {
/* 225 */     this.sndManager.updateAllSounds();
/*     */   }
/*     */ 
/*     */   
/*     */   public void resumeSounds() {
/* 230 */     this.sndManager.resumeAllSounds();
/*     */   }
/*     */ 
/*     */   
/*     */   public void setSoundLevel(SoundCategory category, float volume) {
/* 235 */     if (category == SoundCategory.MASTER && volume <= 0.0F)
/*     */     {
/* 237 */       stopSounds();
/*     */     }
/*     */     
/* 240 */     this.sndManager.setSoundCategoryVolume(category, volume);
/*     */   }
/*     */ 
/*     */   
/*     */   public void stopSound(ISound p_147683_1_) {
/* 245 */     this.sndManager.stopSound(p_147683_1_);
/*     */   }
/*     */ 
/*     */   
/*     */   public SoundEventAccessorComposite getRandomSoundFromCategories(SoundCategory... categories) {
/* 250 */     List<SoundEventAccessorComposite> list = Lists.newArrayList();
/*     */     
/* 252 */     for (ResourceLocation resourcelocation : this.sndRegistry.getKeys()) {
/*     */       
/* 254 */       SoundEventAccessorComposite soundeventaccessorcomposite = (SoundEventAccessorComposite)this.sndRegistry.getObject(resourcelocation);
/*     */       
/* 256 */       if (ArrayUtils.contains((Object[])categories, soundeventaccessorcomposite.getSoundCategory()))
/*     */       {
/* 258 */         list.add(soundeventaccessorcomposite);
/*     */       }
/*     */     } 
/*     */     
/* 262 */     if (list.isEmpty())
...
/*     */ 
/*     */     
/* 268 */     return list.get((new Random()).nextInt(list.size()));
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public boolean isSoundPlaying(ISound sound) {
/* 274 */     return this.sndManager.isSoundPlaying(sound);
/*     */   }
/*     */ }
