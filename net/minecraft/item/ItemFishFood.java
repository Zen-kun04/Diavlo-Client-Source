...
/*  57 */     for (FishType itemfishfood$fishtype : FishType.values()) {
/*     */       
/*  59 */       if (!this.cooked || itemfishfood$fishtype.canCook())
/*     */       {
/*  61 */         subItems.add(new ItemStack(this, 1, itemfishfood$fishtype.getMetadata()));
/*     */       }
/*     */     } 
/*     */   }
/*     */ 
...
/*  69 */     return getUnlocalizedName() + "." + itemfishfood$fishtype.getUnlocalizedName() + "." + ((this.cooked && itemfishfood$fishtype.canCook()) ? "cooked" : "raw");
/*     */   }
/*     */   
/*     */   public enum FishType
/*     */   {
/*  74 */     COD(0, "cod", 2, 0.1F, 5, 0.6F),
/*  75 */     SALMON(1, "salmon", 2, 0.1F, 6, 0.8F),
/*  76 */     CLOWNFISH(2, "clownfish", 1, 0.1F),
/*  77 */     PUFFERFISH(3, "pufferfish", 1, 0.1F);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/*     */     static {
/* 157 */       for (FishType itemfishfood$fishtype : values())
/*     */       {
/* 159 */         META_LOOKUP.put(Integer.valueOf(itemfishfood$fishtype.getMetadata()), itemfishfood$fishtype);
/*     */       }
/*     */     }
/*     */     
