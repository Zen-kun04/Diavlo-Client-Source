...
/* 14 */     for (int i = 0; i < (this.recipeItems[0]).length; i++) {
/*    */       
/* 16 */       Item item = this.recipeItems[0][i];
/*    */       
/* 18 */       for (int j = 0; j < this.recipeItems.length - 1; j++) {
/*    */         
/* 20 */         Item item1 = this.recipeItems[j + 1][i];
/* 21 */         craftManager.addRecipe(new ItemStack(item1), new Object[] { this.recipePatterns[j], Character.valueOf('X'), item });
/*    */       } 
/*    */     } 
/*    */   }
/*    */ }
