...
/*  30 */   public static final Material craftedSnow = (new Material(MapColor.snowColor)).setRequiresTool();
/*  31 */   public static final Material cactus = (new Material(MapColor.foliageColor)).setTranslucent().setNoPushMobility();
/*  32 */   public static final Material clay = new Material(MapColor.clayColor);
/*  33 */   public static final Material gourd = (new Material(MapColor.foliageColor)).setNoPushMobility();
/*  34 */   public static final Material dragonEgg = (new Material(MapColor.foliageColor)).setNoPushMobility();
/*  35 */   public static final Material portal = (new MaterialPortal(MapColor.airColor)).setImmovableMobility();
/*  36 */   public static final Material cake = (new Material(MapColor.airColor)).setNoPushMobility();
/*  37 */   public static final Material web = (new Material(MapColor.clothColor)
/*     */     {
/*     */       public boolean blocksMovement()
/*     */       {
/*  41 */         return false;
/*     */       }
/*  43 */     }).setRequiresTool().setNoPushMobility();
/*  44 */   public static final Material piston = (new Material(MapColor.stoneColor)).setImmovableMobility();
/*  45 */   public static final Material barrier = (new Material(MapColor.airColor)).setRequiresTool().setImmovableMobility();
/*     */   
...
/*  56 */     this.materialMapColor = color;
/*     */   }
/*     */ 
/*     */   
...
/*  81 */     this.isTranslucent = true;
/*  82 */     return this;
/*     */   }
/*     */ 
/*     */   
/*     */   protected Material setRequiresTool() {
/*  87 */     this.requiresNoTool = false;
/*  88 */     return this;
/*     */   }
/*     */ 
/*     */   
/*     */   protected Material setBurning() {
/*  93 */     this.canBurn = true;
/*  94 */     return this;
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean getCanBurn() {
/*  99 */     return this.canBurn;
/*     */   }
/*     */ 
/*     */   
/*     */   public Material setReplaceable() {
/* 104 */     this.replaceable = true;
/* 105 */     return this;
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean isReplaceable() {
/* 110 */     return this.replaceable;
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean isOpaque() {
/* 115 */     return this.isTranslucent ? false : blocksMovement();
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean isToolNotRequired() {
/* 120 */     return this.requiresNoTool;
/*     */   }
/*     */ 
/*     */   
/*     */   public int getMaterialMobility() {
/* 125 */     return this.mobilityFlag;
/*     */   }
/*     */ 
/*     */   
/*     */   protected Material setNoPushMobility() {
/* 130 */     this.mobilityFlag = 1;
/* 131 */     return this;
/*     */   }
/*     */ 
/*     */   
/*     */   protected Material setImmovableMobility() {
/* 136 */     this.mobilityFlag = 2;
/* 137 */     return this;
/*     */   }
/*     */ 
/*     */   
/*     */   protected Material setAdventureModeExempt() {
/* 142 */     this.isAdventureModeExempt = true;
/* 143 */     return this;
/*     */   }
/*     */ 
/*     */   
/*     */   public MapColor getMaterialMapColor() {
/* 148 */     return this.materialMapColor;
/*     */   }
/*     */ }
