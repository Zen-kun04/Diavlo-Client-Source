...
/*     */                 
/* 111 */                 Block block = worldIn.getBlockState((BlockPos)blockpos$mutableblockpos.set(k + i2, l + j2, i1 + k2)).getBlock();
/*     */                 
...
/* 194 */     if (worldIn.isRainingAt(pos.up()) && !World.doesBlockHaveSolidTopSurface((IBlockAccess)worldIn, pos.down()) && rand.nextInt(15) == 1) {
/*     */       
...
/* 211 */     return (random.nextInt(20) == 0) ? 1 : 0;
/*     */   }
/*     */ 
/*     */   
/*     */   public Item getItemDropped(IBlockState state, Random rand, int fortune) {
/* 216 */     return Item.getItemFromBlock(Blocks.sapling);
/*     */   }
/*     */ 
/*     */   
...
/*     */       
/* 223 */       int i = getSaplingDropChance(state);
/*     */       
/* 225 */       if (fortune > 0) {
/*     */         
/* 227 */         i -= 2 << fortune;
...
/*     */       } 
/*     */       
/* 235 */       if (worldIn.rand.nextInt(i) == 0) {
/*     */         
/* 237 */         Item item = getItemDropped(state, worldIn.rand, fortune);
/* 238 */         spawnAsEntity(worldIn, pos, new ItemStack(item, 1, damageDropped(state)));
/*     */       } 
/*     */       
/* 241 */       i = 200;
/*     */       
...
/*     */       } 
/*     */       
/* 253 */       dropApple(worldIn, pos, state, i);
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/* 268 */     return !this.fancyGraphics;
/*     */   }
/*     */ 
/*     */   
/*     */   public void setGraphicsLevel(boolean fancy) {
/* 273 */     this.isTransparent = fancy;
/* 274 */     this.fancyGraphics = fancy;
/* 275 */     this.iconIndex = fancy ? 0 : 1;
/*     */   }
/*     */ 
/*     */   
/*     */   public EnumWorldBlockLayer getBlockLayer() {
/* 280 */     return this.isTransparent ? EnumWorldBlockLayer.CUTOUT_MIPPED : EnumWorldBlockLayer.SOLID;
/*     */   }
/*     */ 
/*     */   
